        ...
        <form @submit.prevent="submit">
          <div class="form-group mb-3">
            ...
            <div>
              <span
                v-if="
                  !$v.form_data.userName.required &&
                  $v.form_data.userName.$dirty
                "
                >Username required!</span
              >
              <span
                v-if="
                  !$v.form_data.userName.alpha && $v.form_data.userName.$dirty
                "
                >Username required!</span
              >
            </div>
          ...
          <div class="form-group mb-3">
            ...
            <div class="invalid-feedback">
              <span
                v-if="
                  (!$v.form_data.email.required || !$v.form_data.email.email) &&
                  $v.form_data.email.$dirty
                "
              >
          ...
          <div class="form-group mb-3">
            ...
            <div class="invalid-feedback">
              <span
                v-if="
                  !$v.form_data.passWord.value.required &&
                  $v.form_data.passWord.value.$dirty
                "
              >
                Password required !
              </span>
              <span
                v-if="
                  !$v.form_data.passWord.value.minLength &&
                  $v.form_data.passWord.value.$dirty
                "
              >
                Password must have more than 8 charaters!
              </span>
              <span
                v-if="
                  !$v.form_data.passWord.value.maxLength &&
                  $v.form_data.passWord.value.$dirty
                "
              >
          ...
          <div class="form-group mb-3">
            ...
            <div class="invalid-feedback">
              <span
                v-if="
                  !$v.form_data.passWord.confirm.required &&
                  $v.form_data.passWord.confirm.$dirty
                "
              >
              ...
              <span
                v-if="
                  !$v.form_data.passWord.confirm.maxLength &&
                  $v.form_data.passWord.confirm.$dirty
                "
              >
              ...
              <span
                v-if="
                  !$v.form_data.passWord.confirm.sameAsPassword &&
                  $v.form_data.passWord.confirm.$dirty &&
                  $v.form_data.passWord.confirm.required
                "
              >
          ...
          <div class="form-group mb-3">
            ...
            <div class="ivalid-feedback">
              <span
                v-if="
                  !$v.form_data.gender.required && $v.form_data.gender.$dirty
                "
