...
<template>
  <div class="login">
    <div class="container">
      ...
      <div
        style="height: 70vh"
        class="login-card d-flex justify-content-center align-items-center"
      >
        <div class="card p-5 pb-4 pt-4 card-border">
          ...
          <div
            class="d-flex gap-2 align-items-center justify-content-center mt-3"
          >
          ...
          <div
            class="d-flex gap-2 justify-content-center align-items-center mt-3"
          >
            <button class="btn btn-light border">
              <b-icon classs="icon-images" icon="google"></b-icon> Google
            </button>
            <button
              class="btn btn-light border d-flex flex-wrap justify-content-center gap-1"
            >
              <img classs="icon-image" src="@/assets/apple.svg" alt="image" />
              <span> Apple ID</span>
            </button>
            <button class="btn btn-light border">
              <b-icon classs="icon-images" icon="facebook"></b-icon> Facebook
            </button>
          </div>
          <p class="mt-3">
